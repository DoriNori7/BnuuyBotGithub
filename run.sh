...
echo "hi kate i deprecated this script on 2023-02-18."
echo "for python dependency reasons"
echo "in the future, run 'poetry run python run.py'"
echo "and to install packages, run 'poetry add (package)'"
echo ""
/home/pi/.local/bin/poetry run python run.py
